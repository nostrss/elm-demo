...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aK, request.au, true);
		} catch (e) {
...
var $author$project$Main$GotPostDetail = function (a) {
	return {$: 3, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aA: false, aC: r.aC, X: r.X, Z: r.Z, aK: r.aK, aV: r.aV, at: r.at, au: r.au}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aC: $elm$http$Http$emptyBody, X: r.X, Z: _List_Nil, aK: 'GET', aV: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, au: r.au});
};
var $author$project$Main$Post = F5(
	function (id, title, content, userId, createdAt) {
		return {T: content, J: createdAt, ab: id, I: title, Q: userId};
	});
...
var $author$project$Main$fetchPostDetail = function (id) {
	return $elm$http$Http$get(
		{
			X: A2($elm$http$Http$expectJson, $author$project$Main$GotPostDetail, $author$project$Main$postDecoder),
			au: 'https://koreanjson.com/posts/' + $elm$core$String$fromInt(id)
		});
};
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {u: frag, v: params, t: unvisited, m: value, x: visited};
	});
...
var $author$project$Main$PostDetailPage = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$PostListPage = {$: 0};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Main$PostListPage, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$PostDetailPage,
			A2(
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
			...
			switch (page.$) {
				case 0:
					return _Utils_Tuple2(
						{C: key, p: page, r: $author$project$Main$Loading, s: $author$project$Main$Loading},
						$author$project$Main$fetchPosts);
				case 1:
					var id = page.a;
					return _Utils_Tuple2(
						{C: key, p: page, r: $author$project$Main$Loading, s: $author$project$Main$Loading},
						$author$project$Main$fetchPostDetail(id));
				default:
					return _Utils_Tuple2(
						{C: key, p: page, r: $author$project$Main$Loading, s: $author$project$Main$Loading},
		...
		var initialModel = _v1.a;
		var cmd = _v1.b;
		return _Utils_Tuple2(initialModel, cmd);
	});
				...
				switch (page.$) {
					case 0:
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{p: page, s: $author$project$Main$Loading}),
							$author$project$Main$fetchPosts);
					case 1:
						var id = page.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{p: page, r: $author$project$Main$Loading}),
							$author$project$Main$fetchPostDetail(id));
					default:
						return _Utils_Tuple2(
							_Utils_update(
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								s: $author$project$Main$Success(
									A2($elm$core$List$take, 10, posts))
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								r: $author$project$Main$Success(post)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
...
var $author$project$Main$viewPostDetail = function (webData) {
	switch (webData.$) {
		case 0:
			return A2(
				$elm$html$Html$div,
		...
		case 2:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Failed to load post detail.')
					]));
		default:
			var post = webData.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'작성자: ' + $elm$core$String$fromInt(post.Q)),
								$elm$html$Html$text(' | '),
...
var $author$project$Main$viewPostItem = function (post) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href(
						'/post/' + $elm$core$String$fromInt(post.ab)),
...
var $author$project$Main$viewPostList = function (webData) {
	switch (webData.$) {
		case 0:
			return A2(
				$elm$html$Html$div,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$map, $author$project$Main$viewPostItem, posts))
					]));
	}
};
			...
			[
				...
				_List_fromArray(
					[
						...
						switch (_v0.$) {
							case 0:
								return $author$project$Main$viewPostList(model.s);
							case 1:
								return $author$project$Main$viewPostDetail(model.r);
							default:
								return A2(
									$elm$html$Html$div,
									_List_Nil,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{aJ: $author$project$Main$init, aM: $author$project$Main$UrlChanged, aN: $author$project$Main$LinkClicked, aU: $author$project$Main$subscriptions, aW: $author$project$Main$update, aX: $author$project$Main$view});
